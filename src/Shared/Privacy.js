      ...
      <div className="terms-bg">
        ...
        <ol>
          ...
          <p className="terms-content">
            Welcome to Santa’s Secret, this application consists of an Alexa
            skill developed by mineshdesigns (“App”) and below is a short guide
            on how the App is used by the User (“You”, “Your” or “User”) and
          ...
          <p className="terms-content">
            ...
            and it is important that you read that information together with
            Alexa{' '}
            <a
            ...
            before installation and use of this App. By installing and using
            this App you hereby agree to all terms and aforementioned privacy
            policies.
          </p>
          <li>
            <Header as="h4" className="headings">
            ...
            <ol>
              <li>
                The only personal data that we shall collect, use, store and
                transfer is your first name.
              </li>
              <li>
                We will only use your personal data for the purpose for which we
                collected it, which is to enable you to use the App.
              </li>
            </ol>
          </li>
          ...
          <p className="terms-content">
            ...
            name, Santa's Secret group and a code word. Users can only use the
            App currently if they have been setup to do so, i.e. they would have
            been emailed these details as part of the setup and draw of their
            Secret Santa group which is handled via the web application and
            outside of the App. This voice input is sent to Amazon and
            mineshdesigns where we use it to understand what the App’s response
            should be. This is absolutely necessary for our service to give you
            an appropriate answer. The only personal data we request is your
            first name, which is collected, stored and processed in line with
            Our Privacy Policy and Amazon’s Privacy Policy.
          </p>
          <li>
            <Header as="h4" className="headings">
              Your rights
          ...
          <p className="terms-content">
            <b>Request access to your personal data</b> (commonly known as a
          ...
          <p className="terms-content">
            <b>Request erasure of your personal data.</b> This enables you to
          ...
          <p className="terms-content">
            <b>Request restriction of processing of your personal data.</b> This
          ...
          <p className="terms-content">
            You may change your mind and withdraw consent at any time by
            contacting us info@mineshdesigns.co.uk but that will not affect the
            lawfulness of any processing carried out before you withdraw your
            consent. Please note that if you withdraw your consent, we may not
            be able to provide certain products or services to you.
          </p>
        </ol>
      </div>
    </Container>
